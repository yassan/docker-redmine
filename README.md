...
make build FLAVOR=redmica VERSION=4.1.4
```
...
make down FLAVOR=redmica VERSION=4.1.4
```
...
make logs FLAVOR=redmica VERSION=4.1.4
```
...
make config FLAVOR=redmica VERSION=4.1.4
```
...
```bash
make up FLAVOR=redmica VERSION=4.1.4 APP_PORT=11084 IMAGE_REPO=yassan/redmine
```
